...
/**
 * Klassenbuch module capability definition
 *
...
$capabilities = array(
    ...
    'mod/hittrainingsnachweis:addinstance' => array(
    ...
    'mod/hittrainingsnachweis:read' => array(
        'captype' => 'read',
    ...
    'mod/hittrainingsnachweis:edit' => array(
        'riskbitmask' => RISK_XSS,
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
